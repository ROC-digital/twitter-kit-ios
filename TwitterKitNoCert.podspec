Pod::Spec.new do |s|
  s.name = "TwitterKitNoCert"
  s.version = "5.2.8"
  s.summary = "Increase user engagement and app growth."
  s.homepage = "https://github.com/ROC-digital/twitter-kit-ios"
  s.documentation_url = "https://github.com/ROC-digital/twitter-kit-ios/wiki"
  s.social_media_url = "https://github.com/ROC-digital"
  s.authors = "Rimnesh Fernandez"
  s.platform = :ios, "9.0"
  s.pod_target_xcconfig = { 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'arm64' }
  s.user_target_xcconfig = { 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'arm64' }
  s.source = { :http => 'https://github.com/ROC-digital/twitter-kit-ios/releases/download/v5.2.8/TwitterKit.zip' }
